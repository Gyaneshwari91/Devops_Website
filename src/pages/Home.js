  ...
  return (
    <>
      ...
      <div className="desc">
        ...
        <p style={{fontSize:16 , fontWeight:600}}>IEEE VIT PUNE has a goal to share our passion for technology by educating students about
        ...
        <p style={{fontSize:16 , fontWeight:600}} >DevOps is an approach or practice that combines the development team and the IT team to collaborate 
